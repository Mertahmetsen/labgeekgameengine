...
## Before you read!
I am not a professional C programmer by any means. The engine most likely has many bad design choices and the README file you are about to read will probably have many factually wrong stuff. *Hey, at least the code compiles, no?*
## Before you compile!
...
- Although the library consists of many *seemingly-independent* headers, in reality, some of these headers can be quite dependent to each other.  Some headers like *"fundamental/basic.h"* are vital, while some headers like *"obsolete/render-groups.h"* have became obsolete in the development.
## Standard Code Structure and "Maps"
This will probably the most difficult part to explain, but I will try my best.
